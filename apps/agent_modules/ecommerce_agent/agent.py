...
class EcommerceSupportAgent(GenericBusinessAgent):
    ...
    brain_config = AgentBrainConfig(
        ...
        lead_title_prefix="Support ticket",
        follow_up_intents=frozenset({"order_status", "refund_request", "exchange_request"}),
    )
