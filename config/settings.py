...
env = environ.Env(
    ...
    RATE_LIMIT_WEBCHAT_PER_MINUTE=(int, 30),
    RATE_LIMIT_WEBHOOK_PER_MINUTE=(int, 120),
    RATE_LIMIT_PROVIDER_TEST_PER_MINUTE=(int, 20),
    RATE_LIMIT_LOGIN_PER_MINUTE=(int, 10),
    RATE_LIMIT_PLAYGROUND_PER_MINUTE=(int, 30),
)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.accounts.context_processors.demo_env_context",
            ],
        },
    },
]
...
# Rate limiting (local cache-based)
RATE_LIMITING_ENABLED = env("RATE_LIMITING_ENABLED")
RATE_LIMIT_WEBCHAT_PER_MINUTE = env("RATE_LIMIT_WEBCHAT_PER_MINUTE")
RATE_LIMIT_WEBHOOK_PER_MINUTE = env("RATE_LIMIT_WEBHOOK_PER_MINUTE")
RATE_LIMIT_PROVIDER_TEST_PER_MINUTE = env("RATE_LIMIT_PROVIDER_TEST_PER_MINUTE")
RATE_LIMIT_LOGIN_PER_MINUTE = env("RATE_LIMIT_LOGIN_PER_MINUTE")
RATE_LIMIT_PLAYGROUND_PER_MINUTE = env("RATE_LIMIT_PLAYGROUND_PER_MINUTE")
